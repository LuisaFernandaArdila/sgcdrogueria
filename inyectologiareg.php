...
<?php
    ...
    $inyectologia = "INSERT INTO inyectologia (Idinyectologia, cedula, nomcliente, codigo, nomproducto, 
    gluteoaplicacion, Idempleados, fecha)
    VALUES ('$Idinyectologia', '$cedula', '$nomcliente', '$codigo', '$nomproducto', '$gluteoaplicacion', 
    '$Idempleados', '$fecha')";
