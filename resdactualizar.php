...
$sql = "SELECT * FROM residuos WHERE Idresiduos = '$Idresiduos'";
?>
<form action="resactualizar.php" method="post">
<table>
<tr>
<th>Id residuos</th>
<th>Fecha informaci&oacute;n</th>
<th>Tipo residuo</th>
<th>Cantidad residuos</th>
<th>Informacion generaci&oacute;n de residuos</th>
<th>Id empleados</th>
</tr>
<?php
...
while($row=mysqli_fetch_assoc($resultado)){?>
        <tr>
        <td><input type="text" name="Idresiduos"value="<?php echo $row ["Idresiduos"];?>"></td>
        <td><input type="text" name="fecha"value="<?php echo $row ["fecha"];?>"></td>
        <td><input type="text" name="tiporesiduo"value="<?php echo $row ["tiporesiduo"];?>"></td>
        <td><input type="text" name="cantidad"value="<?php echo $row ["cantidad"];?>"></td>
        <td><input type="text" name="infogeneracionresiduos"value="<?php echo $row ["infogeneracionresiduos"];?>"></td>
